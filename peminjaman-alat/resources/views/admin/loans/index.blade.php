        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($loan->status == 'pending') <span class="badge bg-warning">Pending</span>
                        @elseif($loan->status == 'disetujui') <span class="badge bg-primary">Sudah Dipinjam</span>
                        @elseif($loan->status == 'kembali') <span class="badge bg-success">Kembali</span>
